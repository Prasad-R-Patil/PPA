...
class Calculate extends WindowAdapter implements ActionListener
{
    ...
    public Calculate(int width, int height, String title)
    {
...
public class Calculator {
    ...
    {
        Calculate cobj = new Calculate(400,400,"Marvellous Calculator");
